...
$site_top = "https://hinata.tami-webcreator.jp/";

//管理者のメールアドレス（送信先） ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "syu.jin.taka@icloud.com";

//送信元（差出人）メールアドレス（管.理者宛て、及びユーザー宛メールの送信元（差出人）メールアドレスです）
...
$Referer_check_domain = "hinata.tami-webcreator.jp";
...
$re_subject = "【Hinata】お問い合わせを承りました";
